...
// =====plane behind
const bgTexture = new THREE.TextureLoader().load("./assets/abstract-bg-texture.png");
...
const box = new THREE.Mesh(new THREE.RoundedBoxGeometry(1.12, 1.12, 1.12, 16, 0.2), new THREE.MeshPhysicalMaterial({
    transmission: 1,
    thickness: 0.4,
    roughness: 0.1,
    envMap: hdrEquirect,
